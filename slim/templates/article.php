<article class="article">
    ...
    <div class="entry-content">
        ...
        <a href="https://twitter.com/intent/tweet?text=<?php echo $article->getTitle()?>&url=http%3A%2F%2Fbarryosull.com%2Fblog%2F<?php echo $article->slug?>&via=barryosull" class="twitter-share-button" data-size="large" data-show-count="false">Tweet</a>
